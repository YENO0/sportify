...
@section('content')
    ...
    <p class="subtitle">
        Welcome to your student portal! View your activities, events, and profile information.
    </p>
    ...
    <div style="display:flex;flex-direction:column;gap:0.75rem;">
        <p style="font-size:0.9rem;color:#d1d5db;">
            As a student, you can view your registered events, track your activities, and manage your profile.
        </p>
