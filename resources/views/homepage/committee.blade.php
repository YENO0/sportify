...
@section('content')
    ...
    <p class="subtitle">
        Welcome to the committee portal! Manage events, students, and activities.
    </p>
    ...
    <div style="display:flex;flex-direction:column;gap:0.75rem;">
        <p style="font-size:0.9rem;color:#d1d5db;">
            As a committee member, you can manage events, view student registrations, and organize activities.
        </p>
