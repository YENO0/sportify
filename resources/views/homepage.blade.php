...
@section('content')
    ...
    <div style="display:flex;flex-direction:column;gap:0.75rem;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:0.6rem;margin-top:0.25rem;">
            <button type="button" style="border:none;border-radius:999px;padding:0.55rem 1.1rem;font-size:0.85rem;font-weight:600;cursor:not-allowed;background:linear-gradient(135deg,#22c55e,#16a34a);color:#0f172a;opacity:0.8;">
                View profile (soon)
            </button>
