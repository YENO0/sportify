...
<div class="create-event-page">
    ...
    <div class="image-upload-area {{ $event->event_poster ? 'is-hidden' : '' }}" id="imageUploadArea">
        ...
        <div id="imagePreviewContainer" class="{{ $event->event_poster ? 'is-block' : 'is-hidden' }}">
                <div class="image-preview-container">
                    <img id="imagePreview" src="{{ $event->event_poster ? asset('storage/' . $event->event_poster) : '' }}" alt="Event poster preview">
                </div>
        ...
        <div class="form-section">
            ...
            <div class="subsection">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="event_name" name="event_name" class="form-input" value="{{ old('event_name', $event->event_name) }}" required>
                </div>
            </div>
            ...
            <div class="subsection">
                ...
                <div class="form-group">
                    ...
                    <div class="textarea-wrapper">
                        <textarea id="event_description" name="event_description" class="form-textarea" maxlength="160" onkeyup="updateCharCounter(this)">{{ old('event_description', $event->event_description) }}</textarea>
                        <span class="char-counter" id="char-counter">{{ strlen($event->event_description ?? '') }} / 160</span>
                    </div>
        ...
        <div class="form-section">
            ...
            <div class="subsection">
                <div class="event-type-cards">
                    @php
                        $isRecurring = $event->event_start_date != $event->event_end_date;
                    @endphp
                    <label class="event-type-card {{ !$isRecurring ? 'selected' : '' }}">
                        <input type="radio" name="event_type" value="single" {{ !$isRecurring ? 'checked' : '' }} onchange="updateEventType(this)">
                    ...
                    <label class="event-type-card {{ $isRecurring ? 'selected' : '' }}">
                        <input type="radio" name="event_type" value="recurring" {{ $isRecurring ? 'checked' : '' }} onchange="updateEventType(this)">
            ...
            <!-- Date and Time -->
            <div class="subsection">
                <div class="date-time-grid {{ $isRecurring ? 'has-end-date' : '' }}" id="date-time-grid">
                    <div class="date-time-input">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <input type="date" id="event_start_date" name="event_start_date" class="form-input" value="{{ old('event_start_date', $event->event_start_date) }}" min="{{ now()->addWeek()->format('Y-m-d') }}" required>
                    </div>
                    <div class="date-time-input {{ $isRecurring ? '' : 'is-hidden' }}" id="end-date-input">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        @php
                            $minWeekDate = now()->addWeek()->format('Y-m-d');
                            $minAfterStart = $isRecurring && $event->event_start_date 
                                ? \Carbon\Carbon::parse($event->event_start_date)->addDay()->format('Y-m-d')
                                : $minWeekDate;
                            $endDateMin = max($minWeekDate, $minAfterStart);
                        @endphp
                        <input type="date" id="event_end_date" name="event_end_date" class="form-input" value="{{ old('event_end_date', $event->event_end_date) }}" min="{{ $endDateMin }}">
                    </div>
                    <div class="date-time-input">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <input type="time" id="event_start_time" name="event_start_time" class="form-input" value="{{ old('event_start_time', $event->event_start_time ?? '10:00') }}" required>
                    </div>
                    <div class="date-time-input">
                        <svg class="input-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <input type="time" id="event_end_time" name="event_end_time" class="form-input" value="{{ old('event_end_time', $event->event_end_time ?? '12:00') }}" required>
                    </div>
                </div>
            ...
            <div class="subsection">
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-input"
                        value="{{ old('registration_due_date', $event->registration_due_date) }}"
            ...
            <div class="subsection">
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" class="form-input" value="{{ old('price', $event->price) }}" min="0" step="0.01" placeholder="0.00" required>
            ...
            <div class="subsection">
                <div class="form-group">
                    ...
                    <input type="number" id="max_capacity" name="max_capacity" class="form-input" value="{{ old('max_capacity', $event->max_capacity) }}" min="1" step="1" placeholder="Enter maximum capacity" required>
        ...
        <div class="form-actions">
            ...
            @if($event->status === 'draft')
                ...
                <button type="submit" name="apply_event" class="btn-primary">Apply</button>
            @else
                <button type="submit" name="save_as_draft" class="btn-secondary" style="background: #6b7280; color: white;">Save as Draft</button>
...
<script>
    ...
    let imageUrl = null;
    const existingImageUrl = '{{ $event->event_poster ? asset("storage/" . $event->event_poster) : "" }}';
